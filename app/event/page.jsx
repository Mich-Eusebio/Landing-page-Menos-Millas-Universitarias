  ...
  return (
    <div className="min-h-screen bg-[#0a192f] text-slate-100 font-sans relative overflow-hidden pb-24">
      ...
      <div className="max-w-6xl mx-auto px-6 py-16 space-y-20 relative z-10">
        ...
        <div className="bg-gradient-to-br from-[#0e213b]/80 to-[#0a1526]/80 border border-blue-500/20 rounded-3xl p-8 md:p-12 space-y-8 text-center max-w-3xl mx-auto relative overflow-hidden">
          ...
          <div className="pt-4 relative z-10">
            <button
              ...
              className="px-8 py-4 bg-yellow-400 hover:bg-yellow-500 text-slate-950 font-black rounded-2xl flex items-center gap-3 shadow-2xl shadow-yellow-400/20 hover:scale-[1.03] active:scale-98 transition-all cursor-pointer text-sm uppercase tracking-wider mx-auto"
            >
        ...
        <div className="pt-12 border-t border-white/10 text-center max-w-xl mx-auto space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center">
            <button
              ...
              className="w-full sm:w-auto px-8 py-4 bg-yellow-400 hover:bg-yellow-500 text-slate-950 font-black rounded-2xl flex items-center justify-center gap-3 shadow-2xl shadow-yellow-400/20 hover:scale-[1.03] active:scale-98 transition-all cursor-pointer text-sm uppercase tracking-wider"
            >
              Reservar Mi Cupo <ArrowRight className="w-4 h-4" />
            </button>
          </div>
        ...
        {/* SECCIÓN 7: FORMULARIO DE REGISTRO */}
