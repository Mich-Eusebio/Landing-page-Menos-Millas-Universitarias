...
import { X, Check, CreditCard, Landmark, Upload, Loader2, Copy } from 'lucide-react';
        ...
        <div className="p-6 border-b border-white/5 flex items-center justify-between">
          <div>
            ...
            <p className="text-[10px] font-bold text-white/40 uppercase tracking-widest mt-1">
              Paso {step} de 3 • {selectedDates.length} días seleccionados
            </p>
          </div>
          <button 
            onClick={onClose} 
              ...
              >
                <div className="grid grid-cols-2 gap-4">
                  <button
                    ...
                    className={`p-4 rounded-2xl border-2 flex flex-col items-center gap-3 transition-all ${formData.paymentMethod === 'transfer' ? 'bg-blue-600/20 border-blue-500 text-white' : 'bg-white/5 border-white/10 text-white/40 hover:border-white/20'}`}
                  >
                  ...
                  <button
                    ...
                    className={`p-4 rounded-2xl border-2 flex flex-col items-center gap-3 transition-all ${formData.paymentMethod === 'card' ? 'bg-blue-600/20 border-blue-500 text-white' : 'bg-white/5 border-white/10 text-white/40 hover:border-white/20'}`}
                  >
                    <CreditCard className="w-8 h-8" />
                    <span className="text-[10px] font-black uppercase tracking-widest">Tarjeta / PayPal</span>
                  </button>
                </div>
                ...
                <div className="flex gap-4">
                  ...
                  <button type="button" onClick={nextStep} disabled={!formData.paymentMethod} className="flex-[2] bg-blue-600 hover:bg-blue-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-black uppercase tracking-widest py-4 rounded-2xl transition-all">Siguiente</button>
                </div>
              </motion.div>
            )}
