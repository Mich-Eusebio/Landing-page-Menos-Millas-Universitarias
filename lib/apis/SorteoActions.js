...
export async function getSoldDays() {
    try {
        ...
        return snapshot.docs.map(document => {
            ...
            const morning = data.morning ? { ...data.morning, nombre: formatName(data.morning.nombre) } : null;
            const afternoon = data.afternoon ? { ...data.afternoon, nombre: formatName(data.afternoon.nombre) } : null;
            return {
                dateStr: document.id,
