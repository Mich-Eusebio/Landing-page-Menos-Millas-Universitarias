 ...
 * @param {Array} tickets - Array de IDs de tickets (ej: ['general-0001', 'general-0002'])
  * @param {string} collectionName - Nombre de la colección ('rifas/v2/tickets_sold_general' o 'rifas/v2/tickets_sold_premium')
 ...
 * @param {Object} transaction - La transacción de Firestore
  * @param {string} firestorePath - Path de la colección ('rifas/v2/general_registrations' o 'rifas/v2/premium_registrations')
